...
crop.factory('cropAreaEllipse', ['cropArea', function (CropArea) {
    ...
    CropAreaEllipse.prototype.getType = function () {
        return 'ellipse';
    };

    CropAreaEllipse.prototype._calcRectangleCorners = function () {
    ...
    CropAreaEllipse.prototype._calcRectangleDimensions = function () {
        var size = this.getSize();
        var se = this.getSouthEastBound();
        return {
            left: size.x,
    ...
    CropAreaEllipse.prototype._isCoordWithinResizeCtrl = function (coord) {
    ...
    CropAreaEllipse.prototype._drawArea = function (ctx, center, size) {
...
crop.factory('cropAreaRect', ['cropArea', function(CropArea) {
  ...
  CropAreaRect.prototype._calcSquareDimensions=function() {
    ...
    return {
      ...
      top: this._y-hSize,
      right: this._x+hSize*this._ratio,
  ...
  CropAreaRect.prototype.draw=function() {
    ...
    for(var i=0,len=resizeIconsCenterCoords.length;i<len;i++) {
      var resizeIconCenterCoords=resizeIconsCenterCoords[i];
      this._cropCanvas.drawIconResizeCircle(resizeIconCenterCoords, this._resizeCtrlBaseRadius, this._resizeCtrlIsHover===i?this._resizeCtrlHoverRatio:this._resizeCtrlNormalRatio, this._ratio);
    }
  };
...
crop.factory('cropArea', ['cropCanvas', 'cropDataService', function(CropCanvas, CropDataService) {
